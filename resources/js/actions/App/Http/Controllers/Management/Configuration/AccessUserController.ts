...
/**
* @see \App\Http\Controllers\Management\Configuration\AccessUserController::index
* @see app/Http/Controllers/Management/Configuration/AccessUserController.php:21
* @route '/cms/configuration/access-user'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/cms/configuration/access-user',
...
/**
* @see \App\Http\Controllers\Management\Configuration\AccessUserController::show
* @see app/Http/Controllers/Management/Configuration/AccessUserController.php:78
* @route '/cms/configuration/access-user/{user}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/cms/configuration/access-user/{user}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Management\Configuration\AccessUserController::edit
* @see app/Http/Controllers/Management/Configuration/AccessUserController.php:86
* @route '/cms/configuration/access-user/{user}/edit'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '/cms/configuration/access-user/{user}/edit',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Management\Configuration\AccessUserController::update
* @see app/Http/Controllers/Management/Configuration/AccessUserController.php:94
* @route '/cms/configuration/access-user/{user}'
*/
...
/**
* @see \App\Http\Controllers\Management\Configuration\AccessUserController::destroy
* @see app/Http/Controllers/Management/Configuration/AccessUserController.php:107
* @route '/cms/configuration/access-user/{user}'
*/
...
const AccessUserController = { index, show, edit, update, destroy }
