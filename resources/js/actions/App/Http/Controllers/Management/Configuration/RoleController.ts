...
/**
* @see \App\Http\Controllers\Management\Configuration\RoleController::index
* @see app/Http/Controllers/Management/Configuration/RoleController.php:20
* @route '/cms/configuration/roles'
*/
...
/**
* @see \App\Http\Controllers\Management\Configuration\RoleController::create
* @see app/Http/Controllers/Management/Configuration/RoleController.php:31
* @route '/cms/configuration/roles/create'
*/
...
create.definition = {
    methods: ["get","head"],
    url: '/cms/configuration/roles/create',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Management\Configuration\RoleController::store
* @see app/Http/Controllers/Management/Configuration/RoleController.php:39
* @route '/cms/configuration/roles'
*/
...
/**
* @see \App\Http\Controllers\Management\Configuration\RoleController::show
* @see app/Http/Controllers/Management/Configuration/RoleController.php:49
* @route '/cms/configuration/roles/{role}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/cms/configuration/roles/{role}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Management\Configuration\RoleController::edit
* @see app/Http/Controllers/Management/Configuration/RoleController.php:57
* @route '/cms/configuration/roles/{role}/edit'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '/cms/configuration/roles/{role}/edit',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Management\Configuration\RoleController::update
* @see app/Http/Controllers/Management/Configuration/RoleController.php:65
* @route '/cms/configuration/roles/{role}'
*/
...
/**
* @see \App\Http\Controllers\Management\Configuration\RoleController::destroy
* @see app/Http/Controllers/Management/Configuration/RoleController.php:75
* @route '/cms/configuration/roles/{role}'
*/
